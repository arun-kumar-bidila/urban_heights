...
class OccupiedRooms extends StatelessWidget {
  final List<RoomEntity> occupiedRooms;
  const OccupiedRooms({super.key, required this.occupiedRooms});
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () {
            context.push(AppRoutes.specificRoomScreen, extra: room);
          },
          child: Container(
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    SizedBox(width: 6),
                    Text(
                      "${formatRent(room.rent)} /month • 4 members",
                      style: TextStyle(
                        fontSize: 12,
